  ...
  return (
    <div className="relative">
      <div className="col-span-2 row-span-1 ">
        <div className=" bg-white flex flex-row items-center  w-[90%] h-20 absolute bottom-[-35px]  left-[6%] rounded-lg">
          ...
          <div className="flex flex-row gap-4 flex-[1%] h-full items-center pl-5">
            <input
              ...
              onChange={() => handleFilterBox("Full Time")}
            />
            <label htmlFor="tickBox">
              <p className="font-bold text-[25px]">Full Time Only</p>
            </label>
